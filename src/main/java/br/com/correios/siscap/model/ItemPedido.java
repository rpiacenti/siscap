...
public class ItemPedido implements Serializable{
	...
	private String UMCNV1; // novo fator de conversao da VW_F41002
	...
	/**
	 * @param uMCNV1 the uMCNV1 to set
	 */
	...
	public boolean equals(Object obj) {
		...
		if (EALITM == null) {
			if (other.EALITM != null) {
				return false;
			}
		} else if (!EALITM.equals(other.EALITM)) {
			return false;
		}
		return true;
	}
	...
	public String getDescricaoEAEDSP() {
		...
		if (EAEDSP.indexOf("O") > -1) {
			setDescricaoEAEDSP("Obsoleto");
		}
	...
	/**
	 * @param valorUnitarioFormatado the valorUnitarioFormatado to set
	 */
	...
	public String getValorUnitarioFormatado(){
		...
		if(getValorUnitario() != null){
			Double dd2dec = Double.parseDouble(getValorUnitario());
	...
	/**
	 * @return the unidMedFormatada
	 */
	public String getUnidMedFormatada() {
		return this.unidMedFormatada;
	}
	/**
	 * @param unidMedFormatada the unidMedFormatada to set
	 */
	public void setUnidMedFormatada(String unidMedFormatada) {
		this.unidMedFormatada = "1 " + this.UMUM + " - " + this.UMCNV1 + " " + this.UMRUM;
	}
	
	public void setUnidMedFormatada2(String unidMedFormatada) {
		this.unidMedFormatada = unidMedFormatada;
	}
	...
	/**
	 * @return the mediaSemetre
	 */
	public String getMediaSemetre() {
		return mediaSemetre;
	}

	/**
	 * @param mediaSemetre the mediaSemetre to set
	 */
	public void setMediaSemetre(String mediaSemetre) {
		this.mediaSemetre = mediaSemetre;
	}
